...
function LiquorInsertPage() {
  ...
  const handleSubmit = async () => {
    ...
    if (!cleanData.name) { toast.error('주류명을 입력하세요.'); return }
    ...
    <div className="content-box liquor-insert-page">
      <div className="form-header">
        ...
        <div className="btn-group">
          ...
          <button className="btn" onClick={() => navigate('/liquor')} disabled={submitting}>취소</button>
        </div>
      </div>
      ...
      <div className="form-section">
        <div className="section-title">구매 / 시음</div>
        <div className="grid-2">
          <div className="form-group">
            <label>가격</label>
      ...
      <div className="form-section">
        <div className="section-title">우리의 평가</div>
        <div className="grid-2">
          <div>
            <div className="form-group">
              <label>👨 남편 평점</label>
      ...
      <div className="form-section">
        ...
        <div className="form-group">
          <label>이미지 URL <span className="hint">※ 첫 번째가 대표 이미지</span></label>
